...
const COUNTRIES = [
  ...
  // ── Added from DHL Zone Guide 2026 — every country with Air zone 1–7 ───────
  //    Mapped Air zone N → Z{N}. (48 new entries; 6 others — QA, JP, IN, SA,
  //    KZ, JO — already existed above and keep their curated zones.)
  { code: 'UY', name: 'Uruguay',                    zone: 'Z1', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'BJ', name: 'Benin',                      zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'MG', name: 'Madagascar',                 zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'ME', name: 'Montenegro',                 zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'NC', name: 'New Caledonia',              zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'GA', name: 'Gabon',                      zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'GI', name: 'Gibraltar',                  zone: 'Z2', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'BS', name: 'Bahamas',                    zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'BL', name: 'St. Barthelemy',             zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'SY', name: 'Syria',                      zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'DM', name: 'Dominica',                   zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'GF', name: 'French Guiana',              zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'VN', name: 'Vietnam',                    zone: 'Z3', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'PR', name: 'Puerto Rico',                zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'RW', name: 'Rwanda',                     zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'SB', name: 'Solomon Islands',            zone: 'Z4', gcc: false, remote: true,  risk: false, restricted: false },
  { code: 'SO', name: 'Somalia',                    zone: 'Z4', gcc: false, remote: true,  risk: false, restricted: false },
  { code: 'BI', name: 'Burundi',                    zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'LS', name: 'Lesotho',                    zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'MO', name: 'Macau',                      zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'MH', name: 'Marshall Islands',           zone: 'Z4', gcc: false, remote: true,  risk: false, restricted: false },
  { code: 'CW', name: 'Curacao',                    zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'DK', name: 'Denmark',                    zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'DJ', name: 'Djibouti',                   zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'ET', name: 'Ethiopia',                   zone: 'Z4', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'PK', name: 'Pakistan',                   zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'AI', name: 'Anguilla',                   zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'GW', name: 'Guinea-Bissau',              zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'ID', name: 'Indonesia',                  zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'KY', name: 'Cayman Islands',             zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'LU', name: 'Luxembourg',                 zone: 'Z5', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'PF', name: 'French Polynesia (Tahiti)',  zone: 'Z5', gcc: false, remote: true,  risk: false, restricted: false },
  { code: 'CV', name: 'Cape Verde',                 zone: 'Z6', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'UZ', name: 'Uzbekistan',                 zone: 'Z6', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'PT', name: 'Portugal',                   zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'AZ', name: 'Azerbaijan',                 zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'IS', name: 'Iceland',                    zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'IR', name: 'Iran',                       zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'IQ', name: 'Iraq',                       zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'SI', name: 'Slovenia',                   zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'XK', name: 'Kosovo',                     zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'KM', name: 'Comoros',                    zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'MW', name: 'Malawi',                     zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'ML', name: 'Mali',                       zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
  { code: 'TZ', name: 'Tanzania',                   zone: 'Z7', gcc: false, remote: false, risk: false, restricted: false },
